...
WHOIS_ERROR_QUERY_RETURNED_NO_CONTACTS_DATA = (
    "it did not return any information about 'admin', 'tech', 'registrant', "
    "'billing' in the 'contacts' data"
)
WHOIS_SUCC_QUERY_RETURNED_NO_REGISTRANT_DATA = (
    "it did not return 'registrant' information in the 'contacts' data"
)
WHOIS_NO_SECONDARY_API = (
    "No second API call required as the server information could not be fetched "
    "from the first WHOIS API call"
)
